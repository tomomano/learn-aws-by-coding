...
image::imgs/handson-04/dynamodb_table_new_item.png[cdk output, 700, align="center"]
...
チュートリアルの内容は， S3 に新しいバケット (Bucket) を作成し，データのアップロード・ダウンロードを実行する．
...
[source, bash]
----
$ python simple_s3.py simples3-bucketXXXX upload tmp.txt
----
